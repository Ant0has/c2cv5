  ...
  const reviews = [
    {
      ...
      text: `Работаем с ${requisitsData.BRAND_NAME} уже 2 года. Отличный сервис для корпоративных перевозок. Водители всегда пунктуальны, документы оформляются быстро.`,
      rating: 5
    },
    {
      name: 'Елена Смирнова',
    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <section className={styles.seoText}>
          <h2>Корпоративные трансферы ${requisitsData.BRAND_NAME} — надежный партнер для вашего бизнеса</h2>
          <p>
            Компания ${requisitsData.BRAND_NAME} предоставляет полный спектр услуг корпоративных перевозок для бизнеса любого масштаба.
          ...
          <p>
            Заключите корпоративный договор с ${requisitsData.BRAND_NAME} и получите: приоритетную подачу автомобиля, гибкую систему оплаты,
