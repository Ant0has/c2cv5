...
export const SVO_FAQ = [
  ...
  {
    question: 'Сколько лет вы работаете по новым регионам?',
    answer: 'По Донецку и Луганску — с 2017 года, более 8 лет (ещё до начала СВО мы возили пассажиров по ДНР и ЛНР). По Запорожской и Херсонской областям, Мариуполю — с 2022 года, 4 года активной работы. Суммарно более 500 успешных поездок в новые регионы.',
  },
  {
    question: 'Что делать если родственники переживают за поездку?',
    answer: 'Диспетчер передаёт родственникам локацию пассажира на ключевых точках маршрута: выезд, подъезд к КПП, прохождение границы, прибытие в город. Связь через WhatsApp/Telegram. Это снимает основное беспокойство для тех, кто остаётся дома.',
  },
] as const
